...
exp0 = celldb.Experiment(subject, '2016-08-18')
...
exp1 = celldb.Experiment(subject, '2016-08-19')
...
exp2 = celldb.Experiment(subject, '2016-08-21')
...
exp2.add_session('12-37-56', 'h', 'AM', 'am_tuinng_curve')
...
exp2.add_session('13-53-00', 'm', 'tuningCurve', 'am_tuinng_curve')
exp2.add_session('14-03-38', 'n', 'AM', 'am_tuning_curve')
exp2.add_session('14-12-19', 'o', 'bandwidth', 'bandwidth_am')


exp3 = celldb.Experiment(subject, '2016-08-22')
...
exp4 = celldb.Experiment(subject, '2016-08-23')
...
exp5 = celldb.Experiment(subject, '2016-08-24')
