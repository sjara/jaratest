...
if __name__ == '__main__':
    ...
    if CASE==0:    
        ...
        SOMmice = db.query("subject=='band005' or subject=='band015' or subject=='band016' or subject=='band027' or subject=='band028' or subject=='band029'")
        ...
        print othercellSS
        print np.mean(othercellSS)
        plot_categorical_scatter_with_mean([thalcellSS,PVcellSS,SOMcellSS,othercellSS], ['thalamus','AC-PV','AC-SOM','AC-unidentified'], colours = ['0.5','b','g','0.5'], xlabel='Cell type', ylabel='Suppression score')
    elif CASE==5:
        db = pd.read_hdf('/home/jarauser/src/jaratest/anna/analysis/all_clusters.h5','database',index_col=0)
        thalmice = db.query("subject=='band022' or subject=='band023'")
        thalCells = thalmice.query("isiViolations<0.02 and nSpikes>2000 and clusterQuality>2.5 and atBestFreq==1")
