...
# mouse_name = 'wifi009'
# date = '20250611'#First session
# session = '114322' #First session

# mouse_name = 'wifi010'
# date = '20250424'#First session
# session = '144540' #First session
# session = '145415'

mouse_name = 'wifi011'
date = '20250424'#First session
session = '162320' #First session
...
for indf, freq in enumerate(possible_freq):
    if p==0:
        INTENSITY_SCALE = [-0.0, 0.01] #[-0.01, 0.05] [-0.01, 0.075]] [-0.01, 0.01]
    elif p==1:
        INTENSITY_SCALE = [-0.0, 0.02]
    elif p==2:
        INTENSITY_SCALE = [-0.0, 0.007]
    elif p==3:
        INTENSITY_SCALE = [-0.0, 0.05]
    elif p==4:
        INTENSITY_SCALE = [-0.0, 0.008]
