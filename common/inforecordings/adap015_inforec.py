...
tetrodeLengthList = [1.260,0.260,0.540,0.340,0.000,0.240,0.110,0.320] #0 is the longest tetrode, other numbers means tetrode is x mm shorter than longest tetrode.
targetRangeLongestTt = (2.00, 3.00)
