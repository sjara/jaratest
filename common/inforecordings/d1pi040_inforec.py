...
info=['anteriourDiI', 'TT1left', 'soundRight', 'A4x2-tet'])
...
exp0.add_site(2400, tetrodes=[1,2,3,4,6,7,8])
exp0.add_session('10-16-09', None, 'noisebursts', 'am_tuning_curve')
...
exp0.add_site(2500, tetrodes=[1,2,3,4,6,7,8])
exp0.add_session('11-19-16', None, 'noisebursts', 'am_tuning_curve')
...
exp0.add_site(2600, tetrodes=[1,2,3,4,6,7,8])
exp0.add_session('12-19-48', None, 'noisebursts', 'am_tuning_curve')
...
exp0.add_session('14-08-41', None, 'noisebursts', 'am_tuning_curve')
...
exp0.add_session('14-45-29', None, 'noisebursts', 'am_tuning_curve')
...
exp0.add_site(2900, tetrodes=[1,2,3,4,5,6,7,8])
exp0.add_session('15-52-49', None, 'noisebursts', 'am_tuning_curve')
...
exp0.add_session('16-24-19', None, 'noisebursts', 'am_tuning_curve')
...
exp0.add_site(3100, tetrodes=[2,3,4,5,6,7,8])
exp0.add_session('16-38-21', None, 'noisebursts', 'am_tuning_curve')
...
exp1.add_site(2450, tetrodes=[2,3,4,5,6,7,8])
exp1.add_session('10-20-16', None, 'noisebursts', 'am_tuning_curve')

exp1.add_site(2900, tetrodes=[2,3,4,5,6,7,8])
exp1.add_session('10-35-39', None, 'noisebursts', 'am_tuning_curve')


exp2 = celldatabase.Experiment(subject, '2019-08-15', 'left_AudStr',
info=['posteriourDiI', 'TT1left', 'soundRight', 'A4x2-tet'])
...
exp3.add_site(2800, tetrodes=[1,2,3,4,6,7,8])
...
exp4.add_site(2400, tetrodes=[1,2,3,4,5,6])
exp4.add_session('13-02-39', None, 'noisebursts', 'am_tuning_curve')
...
exp5.add_site(2506, tetrodes=[1,2,3,4,5,6,7,8])
exp5.add_session('13-50-43', None, 'noisebursts', 'am_tuning_curve')
...
exp5.add_site(2600, tetrodes=[2])
exp5.add_session('14-55-55', None, 'noisebursts', 'am_tuning_curve')
...
exp5.add_site(2700, tetrodes=[1,2])
exp5.add_session('15-45-20', None, 'noisebursts', 'am_tuning_curve')
...
info=['anteriorMidDiD', 'TT1left', 'soundLeft', 'A4x2-tet'])
...
exp6.add_site(2401, tetrodes=[6,7,8])
exp6.add_session('12-50-57', None, 'noisebursts', 'am_tuning_curve')
exp6.add_session('12-52-26', None, 'laserpulse', 'am_tuning_curve')
exp6.add_session('12-54-40', 'a', 'tuningTest', 'am_tuning_curve')

exp6.add_site(2600, tetrodes=[5,7,8])
exp6.add_session('13-13-03', None, 'noisebursts', 'am_tuning_curve')
...
exp6.add_site(2701, tetrodes=[5,7,8])
exp6.add_session('13-35-52', None, 'noisebursts', 'am_tuning_curve')
exp6.add_session('13-37-35', None, 'laserpulse', 'am_tuning_curve')
exp6.add_session('13-39-14', 'c', 'tuningTest', 'am_tuning_curve')

exp6.add_site(2800, tetrodes=[6,7,8])
exp6.add_session('13-57-08', None, 'noisebursts', 'am_tuning_curve')
...
exp6.add_site(2900, tetrodes=[6,7])
exp6.add_session('14-18-17', None, 'noisebursts', 'am_tuning_curve')
...
exp6.add_site(3000, tetrodes=[5,6,7,8])
exp6.add_session('14-42-35', None, 'noisebursts', 'am_tuning_curve')
...
exp6.add_site(3100, tetrodes=[8])
exp6.add_session('14-58-26', None, 'noisebursts', 'am_tuning_curve')
...
exp6.add_site(3200, tetrodes=[2,6])
exp6.add_session('15-26-10', None, 'noisebursts', 'am_tuning_curve')
...
exp6.add_site(3300, tetrodes=[1,2,5,6,8])
exp6.add_session('15-38-52', None, 'noisebursts', 'am_tuning_curve')
...
exp6.add_site(3400, tetrodes=[1,5,6,8])
exp6.add_session('16-36-09', None, 'noisebursts', 'am_tuning_curve')
exp6.add_session('16-37-58', 'l', 'tuningTest', 'am_tuning_curve')
exp6.add_session('16-40-51', None, 'laserpulse', 'am_tuning_curve')

exp6.add_site(3500, tetrodes=[4,5,6,8])
exp6.add_session('16-52-22', None, 'noisebursts', 'am_tuning_curve')
...
exp6.add_site(3600, tetrodes=[4,5,6,8])
exp6.add_session('17-41-16', None, 'noisebursts', 'am_tuning_curve')
...
exp6.add_site(3700, tetrodes=[3,4,5,6,8])
exp6.add_session('18-43-37', None, 'noisebursts', 'am_tuning_curve')
exp6.add_session('18-44-56', 's', 'tuningTest', 'am_tuning_curve')
exp6.add_session('18-47-40', None, 'laserpulse', 'am_tuning_curve')

exp6.add_site(3800, tetrodes=[4,6,8])
exp6.add_session('18-55-26', None, 'noisebursts', 'am_tuning_curve')
exp6.add_session('18-57-25', 't', 'tuningTest', 'am_tuning_curve')
exp6.add_session('19-00-35', None, 'laserpulse', 'am_tuning_curve')

exp6.add_site(3900, tetrodes=[1,2,3,4,6])
exp6.add_session('19-10-44', None, 'noisebursts', 'am_tuning_curve')
