...
exp0 = celldatabase.Experiment(subject, '2017-05-22', 'right_AC', info='medialDiD')
...
exp1 = celldatabase.Experiment(subject, '2017-05-24', 'right_AC', info='middleDiI')
...
exp2 = celldatabase.Experiment(subject, '2017-05-25', 'right_AC', info='middleDiD')
...
exp3 = celldatabase.Experiment(subject, '2017-05-26', 'right_AC', info='lateralDiI')
...
exp4 = celldatabase.Experiment(subject, '2017-05-28', 'right_AC', info='posteriourmiddleDiD')
