...
exp0 = celldatabase.Experiment(subject, '2017-10-24', 'right_AC', info=['medialDiI','TT1ant'])
...
exp0.add_site(1120, tetrodes=[1,2,4,6])
...
exp0.add_site(1200, tetrodes=[1,2,4,6,8])
exp0.add_session('16-02-42', None, 'laserPulse', 'am_tuning_curve')

exp0.add_site(1220, tetrodes=[1,2,4,6,8])
...
exp0.add_site(1230, tetrodes=[1,2,4,6,8])
...
exp0.add_site(1260, tetrodes=[1,2,4,6,8])
exp0.add_session('16-35-57', None, 'laserPulse', 'am_tuning_curve')

exp0.add_site(1270, tetrodes=[1,2,4,6,8])
...
exp1 = celldatabase.Experiment(subject, '2017-10-25', 'right_AC', info=['middleDiD','TT1ant'])
...
exp1.add_site(950, tetrodes=[2,4,5,6,8])
...
exp1.add_session('17-50-56', 'd', 'bandwidth', 'bandwidth_am')
exp1.add_session('18-09-24', 'e', 'noiseAmps', 'am_tuning_curve')


exp2 = celldatabase.Experiment(subject, '2017-10-26', 'right_AC', info=['lateralDiI','TT1ant'])
...
exp3 = celldatabase.Experiment(subject, '2017-10-31', 'left_AC', info=['mediallDiI','TT1ant'])
...
exp4 = celldatabase.Experiment(subject, '2017-11-02', 'left_AC', info=['middleDiD','TT1ant'])
...
exp4.add_site(1000, tetrodes=[2,4,8])
...
exp5 = celldatabase.Experiment(subject, '2017-11-03', 'left_AC', info=['lateralDiI','TT1ant'])
...
exp5.add_session('15-59-25', 'i', 'bandwidth', 'bandwidth_am')
