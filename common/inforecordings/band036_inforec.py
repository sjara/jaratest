...
exp1 = celldatabase.Experiment(subject, '2017-09-25', 'left_AC', info=['medialDiI','TT1ant'])
...
exp2 = celldatabase.Experiment(subject, '2017-09-27', 'left_AC', info=['middleDiD','TT1ant'])
