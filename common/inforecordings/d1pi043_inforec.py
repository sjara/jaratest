...
exp0.add_site(2800, tetrodes=[7,8])
...
exp0.add_site(3000, tetrodes=[6,7,8])
...
exp3.add_site(3000, tetrodes=[1,2,5])
...
exp4.add_site(3000, tetrodes=[1,2,4])
...
exp4.add_site(3100, tetrodes=[1,2,4,8])
