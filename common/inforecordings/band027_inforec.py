...
exp0 = celldatabase.Experiment(subject, '2017-05-03', 'right_AC', info='medialDiI')
...
exp1 = celldatabase.Experiment(subject, '2017-05-05', 'right_AC', info='middleDiD')
...
exp2 = celldatabase.Experiment(subject, '2017-05-06', 'right_AC', info='medialDiI')
...
exp3 = celldatabase.Experiment(subject, '2017-05-07', 'right_AC', info='posteriormedialDiD')
