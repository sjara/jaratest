...
exp1.add_site(2500, tetrodes=[1,2,5,6,7,8])
...
exp1.add_site(2900, tetrodes=[1,2,3,7,8])
...
exp1.add_site(3000, tetrodes=[1,2,4,7])
...
exp1.add_site(3400, tetrodes=[1,3,4,6,7])
...
exp2.add_site(2700, tetrodes=[1,2,7])
...
exp2.add_site(2800, tetrodes=[2,4,7])
...
exp2.add_site(2900, tetrodes=[1,2,3,4,7,8])
...
exp2.add_site(3000, tetrodes=[1,2,3,4,5,6,7,8])  # all sites seem to have spikes so no reference
...
exp2.add_site(3200, tetrodes=[1,2,3,4,5,6,8])
...
exp2.add_site(3300, tetrodes=[1,2,3,4,5,6,8])
...
exp2.add_site(3400, tetrodes=[1,2,3,4,5,6,8])
