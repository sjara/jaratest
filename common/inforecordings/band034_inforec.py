...
exp0 = celldatabase.Experiment(subject, '2017-08-30', 'right_AC', info=['medialDiI','TT1ant'])
...
exp0.add_site(1000, tetrodes=[2,4,8])
...
exp1 = celldatabase.Experiment(subject, '2017-09-01', 'right_AC', info=['middleDiD','TT1ant'])
...
exp2 = celldatabase.Experiment(subject, '2017-09-01', 'left_AC', info=['middleDiD','TT1ant'])
