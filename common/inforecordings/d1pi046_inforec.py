...
exp0 = celldatabase.Experiment(subject, '2020-02-15', 'right_AudStr', 'anteriorDiI',
...
exp1 = celldatabase.Experiment(subject, '2020-02-16', 'right_AudStr', 'anteriorDiD',
    info=['TT1left', 'soundLeft', 'A4x2-tet'])
...
exp2 = celldatabase.Experiment(subject, '2020-02-17', 'right_AudStr', 'middleDiI',
    info=['TT1left', 'soundLeft', 'A4x2-tet'])
...
exp3 = celldatabase.Experiment(subject, '2020-02-18', 'left_AudStr', 'anteriorDiI',
...
exp3.add_site(2900, tetrodes=[1,6,7,8])
...
exp3.add_site(3100, tetrodes=[2,4,6,7,8])
...
exp3.add_site(3200, tetrodes=[4,5,6,7,8])
...
exp3.add_site(3300, tetrodes=[2,4,5,6,7,8])
...
exp3.add_site(3400, tetrodes=[2,4,5,6,7,8])
...
exp3.add_site(3500, tetrodes=[2,3,4,5,6,7,8])
...
exp3.add_site(3600, tetrodes=[1,2,4,5,6,7,8])
...
exp3.add_site(3700, tetrodes=[1,2,3,4,6,7,8])
...
exp3.add_site(3800, tetrodes=[1,2,4,5,6,7,8])
...
exp4 = celldatabase.Experiment(subject, '2020-02-19', 'left_AudStr', 'middleDiD',
    info=['TT1left', 'soundRight', 'A4x2-tet'])
...
exp4.add_site(3000, tetrodes=[2,3,4])
...
exp4.add_site(3100, tetrodes=[1,2,3,4])
...
exp4.add_site(3200, tetrodes=[1,2,8])
...
exp4.add_site(3300, tetrodes=[1,2,3,6,8])
...
exp4.add_site(3400, tetrodes=[1,2,6,8])
...
# # Probe in at: 10:37
#
# exp5.add_site(3400, tetrodes=[4,5,6])
...
#
# exp5.add_site(3700, tetrodes=[5,6,8])
...
#
# exp5.add_site(3800, tetrodes=[4,6,7,8])
...
#
# exp5.add_site(3900, tetrodes=[5,6,8])
...
#
# exp5.add_site(4000, tetrodes=[4,5,6,8])
