...
exp3.add_session('10-03-03', 'b', 'am', 'am_tuning_curve')
...
exp4.add_session('13-34-33', 'f', 'am', 'am_tuning_curve')
...
exp5 = celldatabase.Experiment(subject, '2020-02-20', 'left_AudStr',
