...
exp2 = celldatabase.Experiment(subject, '2021-12-13', brainArea='leftAC', probe = 'NPv1-2881/2872', recordingTrack='anterolateralDiI', info=['facesLeft', 'soundRight']) #reference = tip
...
exp3 = celldatabase.Experiment(subject, '2021-12-14', brainArea='leftAC', probe = 'NPv1-2881/2872', recordingTrack='anteromedialDiD', info=['facesLeft', 'soundRight']) #reference = tip
...
exp4 = celldatabase.Experiment(subject, '2021-12-15', brainArea='leftAC', probe = 'NPv1-2881/2872', recordingTrack='DiD', info=['facesLeft', 'soundRight']) #reference = tip
...
exp5 = celldatabase.Experiment(subject, '2021-12-17', brainArea='rightAC', probe = 'NPv1-2881/2872', recordingTrack='caudolateralDiI', info=['facesLeft', 'soundLeft']) #reference = tip
