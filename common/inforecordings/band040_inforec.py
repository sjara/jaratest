...
exp0 = celldatabase.Experiment(subject, '2017-11-07', 'right_AC', info=['medialDiI','TT1ant'])
...
exp1 = celldatabase.Experiment(subject, '2017-11-09', 'right_AC', info=['middleDiD','TT1ant'])
...
exp1.add_session('13-42-20', 'e', 'noiseAmps', 'am_tuning_curve')
...
exp2 = celldatabase.Experiment(subject, '2017-11-10', 'right_AC', info=['lateralDiI','TT1ant'])
...
exp3 = celldatabase.Experiment(subject, '2017-11-13', 'left_AC', info=['medialDiD','TT1ant'])
...
exp4 = celldatabase.Experiment(subject, '2017-11-14', 'left_AC', info=['middleDiI','TT1ant'])
...
exp5 = celldatabase.Experiment(subject, '2017-11-15', 'left_AC', info=['lateralDiD','TT1ant'])
...
exp6 = celldatabase.Experiment(subject, '2017-11-16', 'left_AC', info=['medialDiI','TT1ant'])
