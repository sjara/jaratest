...
exp0 = celldatabase.Experiment(subject, '2018-03-29', 'right_AC', info=['medialDiD','TT1ant','soundleft'])
...
exp1 = celldatabase.Experiment(subject, '2018-04-02', 'right_AC', info=['middleDiI','TT1ant','soundleft'])
...
exp2 = celldatabase.Experiment(subject, '2018-04-03', 'right_AC', info=['lateralDiD','TT1ant','soundleft'])
...
exp3 = celldatabase.Experiment(subject, '2018-04-03', 'left_AC', info=['lateralDiD','TT1ant','soundright'])
...
exp4 = celldatabase.Experiment(subject, '2018-04-04', 'left_AC', info=['middleDiI','TT1ant','soundright'])
...
exp5 = celldatabase.Experiment(subject, '2018-04-05', 'left_AC', info=['medialDiD','TT1ant','soundright'])
