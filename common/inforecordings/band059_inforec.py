...
exp0 = celldatabase.Experiment(subject, '2018-03-08', 'right_AC', info=['medialDiI','TT1ant','soundleft'])
...
exp1 = celldatabase.Experiment(subject, '2018-03-09', 'right_AC', info=['middleDiD','TT1ant','soundleft'])
...
exp2 = celldatabase.Experiment(subject, '2018-03-11', 'right_AC', info=['lateralDiI','TT1ant','soundleft'])
...
exp3 = celldatabase.Experiment(subject, '2018-03-11', 'right_AC', info=['lateralDiD','TT1ant','soundleft'])
...
exp4 = celldatabase.Experiment(subject, '2018-03-19', 'left_AC', info=['medialDiI','TT1ant','soundright'])
...
exp5 = celldatabase.Experiment(subject, '2018-03-26', 'left_AC', info=['lateralDiD','TT1ant','soundright'])
