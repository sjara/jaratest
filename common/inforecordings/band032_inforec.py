...
exp0 = celldatabase.Experiment(subject, '2017-07-14', 'right_AC', info='medialDiI')
...
exp0.add_site(1120, tetrodes = [1,2,3,4,8])
...
exp1 = celldatabase.Experiment(subject, '2017-07-17', 'left_AC', info='medialDiI')
...
exp2 = celldatabase.Experiment(subject, '2017-07-21', 'right_AC', info='middleDiD')
...
exp3 = celldatabase.Experiment(subject, '2017-07-21', 'left_AC', info='middleDiD')
...
exp4 = celldatabase.Experiment(subject, '2017-07-23', 'left_AC', info='lateralDiI')
