...
exp0 = celldatabase.Experiment(subject, '2020-02-29', 'right_AudStr', 'anteriorDiI',
...
exp1 = celldatabase.Experiment(subject, '2020-03-01', 'right_AudStr', 'middleDiD',
    info=['TT1left', 'soundLeft', 'A4x2-tet'])
...
exp1.add_site(3000, tetrodes=[3,4,6,7,8])
...
exp1.add_site(3200, tetrodes=[7,8])
...
exp1.add_site(3700, tetrodes=[3,5,7,8])
...
exp1.add_site(3800, tetrodes=[3,5,7,8])
...
exp1.add_site(3900, tetrodes=[3,5,7])
...
exp2 = celldatabase.Experiment(subject, '2020-03-02', 'left_AudStr', 'anteriorDiI',
...
exp2.add_site(3300, tetrodes=[4,6])
...
exp2.add_site(3400, tetrodes=[3,4,6])
...
exp2.add_site(3600, tetrodes=[3,4,5,6])
...
exp2.add_site(3700, tetrodes=[3,4,5,6])
...
exp2.add_site(3800, tetrodes=[3,4,5,6])
...
exp2.add_site(3900, tetrodes=[3,4])
...
exp2.add_site(4000, tetrodes=[3,4])
