...
exp0 = celldatabase.Experiment(subject, '2016-08-29', 'right_AC', info='centerDiO')
...
exp0.add_session('13-27-15', None, 'laserPulse2.5', 'am_tuning_curve')
exp0.add_session('13-29-46', None, 'longLaserPulse2.5', 'am_tuning_curve')
...
exp0.add_session('14-15-29', None, 'laserPulse2.5', 'am_tuning_curve')
exp0.add_session('14-18-16', None, 'longLaserPulse2.5', 'am_tuning_curve')
...
exp0.add_session('15-02-18', None, 'laserPulse2.5', 'am_tuning_curve')
exp0.add_session('15-05-07', None, 'longLaserPulse2.5', 'am_tuning_curve')
...
exp1 = celldatabase.Experiment(subject, '2016-08-30', 'right_AC', info='lateralDiI')
...
exp2 = celldatabase.Experiment(subject, '2016-08-31', 'right_AC', info='medialDiD')
...
exp3 = celldatabase.Experiment(subject, '2016-09-09', 'left_AC', info='middleDiI')
...
exp4 = celldatabase.Experiment(subject, '2016-09-11', 'left_AC', info='medialDiO')
