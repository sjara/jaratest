...
site1 = experiment.add_site(depth=2260, '2015-12-14', tetrodes=[1,3,7]) 
...
site1 = experiment.add_site(depth=2260, '2015-12-15', tetrodes=[1,2,3,4,5,6,7,8]) 
...
#site2 = experiment.add_site(depth=2260, '201', tetrodes=[1,2,3,4,5,6,7,8]) #these recordings were done at site1 but removed ref channel
...
site1 = experiment.add_site(depth=2420, '2015-12-16', tetrodes=[1,2,3,4,5,6,7,8]) 
...
site1 = experiment.add_site(depth=2420, '2015-12-17', tetrodes=[8]) 
...
site1 = experiment.add_site(depth=2420, '2015-12-18', tetrodes=[1,2,3,4,5,6,7,8]) 
...
site1 = experiment.add_site(depth=2420, '2015-12-19', tetrodes=[1,2,3,4,5,6,7,8]) 
...
site1 = experiment.add_site(depth=2520, '2015-12-21', tetrodes=[7,8]) 
...
site1 = experiment.add_site(depth=2520, '2015-12-22', tetrodes=[1,2,3,4,5,6,7,8]) 
...
site1 = experiment.add_site(depth=2520, '2015-12-23', tetrodes=[1,2,3,4,5,6,7,8]) 
...
site1 = experiment.add_site(depth=2520, '2015-12-24', tetrodes=[1,2,3,4,5,6,7,8]) 
...
site1 = experiment.add_site(depth=2520, '2016-01-08', tetrodes=[5,7,8]) 
...
site1 = experiment.add_site(depth=2520, '2016-01-09', tetrodes=[1,2,3,4,5,6,7,8]) 
...
site1 = experiment.add_site(depth=2520, '2016-01-10', tetrodes=[1,2,3,4,5,6,7,8]) 
