...
exp7 = celldatabase.Experiment(subject, '2022-02-16', brainArea='rightAC', probe = 'NPv1-8131', recordingTrack='caudomedialDiD', info=['caudomedialDiD', 'soundLeft']) #reference = external
