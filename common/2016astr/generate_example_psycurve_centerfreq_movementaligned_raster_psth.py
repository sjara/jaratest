'''
Generate and store intermediate data for plot showing movement-onset-aligned firing activity of astr neurons recorded in psychometric curve task, only trials of the two middle frequencies are plotted. Data for raster and psth are saved separately. 
