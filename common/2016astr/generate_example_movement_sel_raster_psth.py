'''
Generate and store intermediate data for plot showing movement-selectivity of astr neurons. Data for raster and psth are saved separately. 
...
np.savez(outputFullPath, spikeTimestamps=spikeTimestamps, eventOnsetTimes=EventOnsetTimes, indexLimitsEachTrial=indexLimitsEachTrial, trialsEachCond=trialsEachCond, colorEachCond=colorEachCond, script=scriptFullPath, EPHYS_SAMPLING_RATE=EPHYS_SAMPLING_RATE, soundTriggerChannel=soundTriggerChannel, plotByBlock=plotByBlock, minBlockSize=minBlockSize, timeRange=timeRange, colorForLowBlock=colorsDict['lowBlock'], colorForHighBlock=colorsDict['highBlock'], **cellParams)
