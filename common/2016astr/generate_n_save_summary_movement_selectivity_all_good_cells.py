...
Output contains animalName, selective(boolean vector indicating whether each cell was significantly modulated by movement), and movementModI(modulation index for each cell).
Lan Guo20161222
'''
