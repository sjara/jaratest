...
axHighestSustained = plt.subplot(gs[0, 0:3])
axPercentSyncD1 = plt.subplot(gs[0, 3:4])
axPercentSyncnD1 = plt.subplot(gs[0, 5:6])
axRateDescrim = plt.subplot(gs[0, 6:9])
axPhaseDecrim = plt.subplot(gs[0, 9:12])
