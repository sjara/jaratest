...
database_generation_funcs.py module. 
...
studyparams.py)
3. Calculate statistics for D1/nD1 determination for each cell using laserpulse data
4. Calculate the response latency for each cell using tuning curve data 
5. Calculate the BW10 for each cell using tuning curve data 
5. Calculate the onset to sustained ratio for each cell using tuning curve data 
...
for indIter, (indRow, dbRow) in enumerate(db.iterrows()):
    ...
    try:
        ...
        db.at[indRow, 'laserpulse_SpikeCountChange'] = spikeCountChange
        db.at[indRow, 'laserpulse_baselineSpikeCount'] = nspkBaseLaserMean  # Mean of baseline FR
        db.at[indRow, 'laserpulse_responseSpikeCount'] = nspkRespLaserMean  # Mean of response FR
...
# ========================== Tuning Curve ==========================
    ...
    # ========================== Latency ==========================
        ...
        db.at[indRow,'tuningResponseRate'] = respTuningMean  # The FR of the cell response (0 to 100 ms) 
