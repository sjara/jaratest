...
figFilename = 'SuppFig10_effect_of_inhibitory_inactivation_on_suppression_pure_tone' # Do not include extension
...
labelPosX = [0.02, 0.4]   # Horiz position for panel labels
