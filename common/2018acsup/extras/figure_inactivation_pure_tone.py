...
if PANELS[2]:
    ...
    summaryDataFullPath = os.path.join('/tmp/',summaryFileName)
    ...
    PVsupNoLaser = summaryData['fitMeanPVsupPureToneNoLaser']
    PVsupLaser = summaryData['fitMeanPVsupPureToneLaser']
    
    semPVsupNoLaser = summaryData['fitSemPVsupPureToneNoLaser']
    semPVsupLaser = summaryData['fitSemPVsupPureToneLaser']
    
    SOMsupNoLaser = summaryData['fitMeanSOMsupPureToneNoLaser']
    SOMsupLaser = summaryData['fitMeanSOMsupPureToneLaser']
    
    semSOMsupNoLaser = summaryData['fitSemSOMsupPureToneNoLaser']
    semSOMsupLaser = summaryData['fitSemSOMsupPureToneLaser']
...
if PANELS[3]:
    ...
    PVpeakChangeFR = summaryData['fitPVpeakChangeFRPureTone']
    PVWNChangeFR = summaryData['fitPVWNChangeFRPureTone']
    
    SOMpeakChangeFR = summaryData['fitSOMpeakChangeFRPureTone']
    SOMWNChangeFR = summaryData['fitSOMWNChangeFRPureTone']
