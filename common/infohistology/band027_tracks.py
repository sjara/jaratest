...
tracks = [
    ...
    {'subject': subject, 'brainArea': 'RightAC', 'histImage': 'p2-B6-02',
     ...
     {'subject': subject, 'brainArea': 'RightAC', 'histImage': 'p2-B6-02',
      'recordingTrack': 'posteriormedialDiD', 'shank': 1, 'atlasZ': 238},

     {'subject': subject, 'brainArea': 'RightAC', 'histImage': 'p2-C3-02',
      'recordingTrack': 'medialDiI', 'shank': 2, 'atlasZ': 240},

     {'subject': subject, 'brainArea': 'RightAC', 'histImage': 'p2-C3-02',
      'recordingTrack': 'middleDiD', 'shank': 2, 'atlasZ': 240},
