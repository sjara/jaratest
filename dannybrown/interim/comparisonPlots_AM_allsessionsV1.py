...
dates = ['2022-08-18', '2022-08-19', '2022-08-23']
mice = ['pure012', 'pure013']
for mouse in mice:
    for day in dates:
...
#            if mouse == 'pure013':
#                linekind = 'solid'
#            if params == 'pureTone20sec':
#                linecolor = 'darkblue'
#            else:
#                linecolor = 'darkgreen'
            
            plt.plot(pupilDilationTimeWindowVec, meanpAreaDilated[0], linewidth = 3, label = f'{date}, {subject}, {params}')
            plt.ylim([600,1850])
            plt.grid(b = True)
            plt.title('All 20 second tests thus far.  Plot created 2022-08-25', fontsize=18)
