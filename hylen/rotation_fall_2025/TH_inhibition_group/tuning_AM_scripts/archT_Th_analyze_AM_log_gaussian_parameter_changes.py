...
class AnalysisConfig:
    ...
    def output_dir(self) -> str:
        return str(get_reports_subdir('arch024/tuning_AM_gaussian_parameter_analysis'))
...
class LogGaussianFitLoader:
    ...
    def filter_empirically_tuned(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        # Load AM metrics to get tuning classification
        metrics_dir = '/data/reports/tuning_AM_analysis'
