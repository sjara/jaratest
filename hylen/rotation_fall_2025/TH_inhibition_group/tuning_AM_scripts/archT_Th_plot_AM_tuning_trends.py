...
class PDFGenerator:
    ...
    def _create_combined_page(
        ...
        fig.suptitle(
            f'Th-pStr Inhibition (ArchT) - AM Tuning - Laser Effect Trends\n'
...
class CombinedVisualizationCoordinator:
    ...
    def _create_category_distribution_chart(self, df_merged: pd.DataFrame, categories: List[str]):
        ...
        # Save figure
        output_path = os.path.join(self.output_dir, 'archT_Th_category_distribution_summary.png')
    ...
    def _generate_pdfs(
        ...
        for category in categories:
            ...
            output_path = os.path.join(self.output_dir, f'{category}_archT_Th_tuning_AM.pdf')
