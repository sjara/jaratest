...
class AnalysisConfig:
    ...
    metrics_dir: str = '/data/reports/arch024/control_sessions/tuning_AM_analysis'  # AM tuning output directory
    override_file: str = '/data/reports/arch024/control_sessions/tuning_AM_analysis/classification_overrides.csv'
