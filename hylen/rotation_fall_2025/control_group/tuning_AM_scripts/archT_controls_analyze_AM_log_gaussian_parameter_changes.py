...
class AnalysisConfig:
    ...
    experiment_name: str = 'Controls (laser blocked) AM'
    ...
    def gaussian_fits_dir(self) -> str:
        """Directory for Gaussian fit reports."""
        return str(get_reports_subdir('control_group/tuning_AM_gaussian_fits'))

    @property
    def output_dir(self) -> str:
        """Directory for output reports."""
        return str(get_reports_subdir('control_group/tuning_AM_gaussian_parameter_analysis'))
    
    @property
    def metrics_dir(self) -> str:
        """Directory for AM metrics reports."""
