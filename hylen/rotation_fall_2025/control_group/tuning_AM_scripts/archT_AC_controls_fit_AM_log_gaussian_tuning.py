...
Features:
- Fits 3 parameters (baseline fixed from pre-stim window, amplitude/preferred_rate/sigma fitted)
...
class FitConfig:
    ...
    # =========================================================================
    # DIRECTORIES - Change these to save outputs elsewhere
    # =========================================================================
    @property
...
class SessionFittingCoordinator:
    ...
    def fit_session(
        ...
        for idx, row in df_analyzed.iterrows():
            ...
            # Get empirical best rate and baseline from metrics
            empirical_best_rate = row['best_rate']
            baseline_prestim = row['baseline_rate']  # Pre-stimulus baseline from metrics
