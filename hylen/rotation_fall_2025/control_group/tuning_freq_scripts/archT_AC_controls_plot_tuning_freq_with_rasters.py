...
- Laser OFF vs ON comparison in tun        # Use jaratoolbox's raster_plot
        ...
        ax.axvspan(self.config.response_window[0], self.config.response_window[1],
                  facecolor='yellow', alpha=0.1, zorder=0, label='Analysis window')
...
class PDFGenerator:
    ...
    def _create_combined_page(
        ...
        fig.suptitle(
            f'Control Group (Laser Blocked) - Frequency Tuning - Raw Tuning Curves with Rasters\n'
