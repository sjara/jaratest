...
SESSIONS = {
    0: SessionConfig('arch024', '2025-04-16', 2780),
    1: SessionConfig('arch024', '2025-04-16', 3500),
    2: SessionConfig('arch024', '2025-04-10', 2780),
    3: SessionConfig('arch024', '2025-04-10', 3500),
    4: SessionConfig('arch024', '2025-04-15', 2780),
    5: SessionConfig('arch024', '2025-04-15', 3500),
}
...
def main():
    ...
    output_dir = '/data/reports/arch024_rasters/'
    save_figs = True
