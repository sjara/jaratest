...
class PlotConfig:
    ...
    shank_filter: Optional[List[int]] = field(default_factory=lambda: [0, 1, 2, 3])
...
SESSIONS = {
    0: SessionConfig('arch018', '2024-12-09', 3780),
    1: SessionConfig('arch018', '2024-12-09', 4500),
    2: SessionConfig('arch018', '2024-12-18', 3780),
    3: SessionConfig('arch018', '2024-12-18', 4500),
    4: SessionConfig('arch018', '2024-12-10', 3780),
    5: SessionConfig('arch018', '2024-12-10', 4500),
    6: SessionConfig('arch018', '2024-12-17', 3780),
    7: SessionConfig('arch018', '2024-12-17', 4500),
}
...
def main():
    ...
    output_dir = '/data/reports/arch018_rasters/'
    save_figs = True
