...
SESSIONS = {
    ...
    6: SessionConfig('arch019', '2024-11-21', 3780),
    7: SessionConfig('arch019', '2024-11-21', 4500),
    8: SessionConfig('arch019', '2024-12-04', 3780),
    9: SessionConfig('arch019', '2024-12-04', 4500),
    10: SessionConfig('arch019', '2024-12-06', 3780),
    11: SessionConfig('arch019', '2024-12-06', 4500),
}
...
def main():
    ...
    output_dir = '/data/reports/arch019_rasters/'
    save_figs = True
