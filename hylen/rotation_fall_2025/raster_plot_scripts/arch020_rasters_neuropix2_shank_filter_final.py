...
SESSIONS = {
    0: SessionConfig('arch020', '2025-03-24', 2780),
    1: SessionConfig('arch020', '2025-03-24', 3500),
    2: SessionConfig('arch020', '2025-03-25', 2780),
    3: SessionConfig('arch020', '2025-03-25', 3500),
    4: SessionConfig('arch020', '2025-03-27', 2780),
    5: SessionConfig('arch020', '2025-03-27', 3500),
    6: SessionConfig('arch020', '2025-03-31', 2780),
    7: SessionConfig('arch020', '2025-03-31', 3500),
...
def main():
    ...
    output_dir = '/data/reports/arch020_rasters/'
    save_figs = True
