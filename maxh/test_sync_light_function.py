...
proc_dir = f'/data/videos_processed/{subject}'
behav_dir = f'/data/behavior/'

VSESSION = 2
if VSESSION==0:
    proc_filename = 'acid010_oddball_sequence_20230809_03doi_proc.npy'
    behav_filename = 'acid010_oddball_sequence_20230809cdoi.h5'
elif VSESSION==1:
    # Missing blink
    proc_filename = 'acid010_oddball_sequence_20230814_01doi_proc.npy'
    behav_filename = 'acid010_oddball_sequence_20230814adoi.h5'
elif VSESSION==2:
    proc_filename = 'acid010_oddball_sequence_20230814_03saline_proc.npy'
    behav_filename = 'acid010_oddball_sequence_20230814csaline.h5'
elif VSESSION==3:
    proc_filename = 'acid006_oddball_sequence_20230511_01pre_proc.npy'
    behav_filename = 'acid006_oddball_sequence_20230511apre.h5'
elif VSESSION==4:
