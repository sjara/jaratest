'''
Translate information from Billy about ephys sessions to simple allcells file (without tuning, depth, or cluster quality). These are used for running plots and reports before quality is finished.
'''
