...
'''
#THIS SESSION IS MESSED UP. cant find behavior file when the file does exist
oneES = eSession(animalName='test055',##################################
...
#THIS BEHAVIOR SESSION IS MESSED UP. The behavior file was not saved correctly and is just empty
oneES = eSession(animalName='test055',#######################################################################
...
cellDB.append_session(oneES)
'''
#THIS SESSION IS MESSED UP. There are 986 ephys trials and 1172 behavior trials
oneES = eSession(animalName='test055',############################################################
...
#THIS SESSION IS MESSED UP. This session crashes in clustering
oneES = eSession(animalName='test055',######################################
...
#THIS SESSION IS MESSED UP. Last trial is skipped. ephys is 1080 and behavior is 1081
oneES = eSession(animalName='test055',####################################################
