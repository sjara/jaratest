...
#This session has a skipped trial at trial 748
oneES = eSession(animalName='test017',
...
cellDB.append_session(oneES)
'''
#THIS SESSION IS MESSED UP. he doesnt switch so there is a division by zero spikes on one side
oneES = eSession(animalName='test017',#################################################
...
#THIS SESSION IS MESSED UP. did not change blocks. wasn't on the switching task
oneES = eSession(animalName='test017',
