...
python copyFileQualityClusterPsyCurve.py test055
python copyFileResponsiveClusterPsyCurve.py test055
python copyFileNoISIPsyCurve.py test055
...
python addMinTrialCheckPsyCurve.py adap015
python addMinBehavePerformancePsyCurve.py adap015
python add_sound_response_stat.py adap015
python copyFileQualityClusterPsyCurve.py adap015
python copyFileResponsiveClusterPsyCurve.py adap015
python copyFileNoISIPsyCurve.py adap015
'''
