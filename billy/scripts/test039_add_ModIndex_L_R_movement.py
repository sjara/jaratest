'''
Lan Guo 20160411, BILLY TRIED TO ADAPT LANS CODE TO USE ON HIS ALLCELLS FILES

THIS FILE IS RUN WITH THIS COMMAND:

python test039_add_modIndex_L_R_movement.py 0 0.1 adap017 adap015 adap013
...
########---Input system arguments after python file name: start of countTimeRange, end of countTimeRange, subjects (countTimeRange is in seconds)---#############
if sys.argv[1]=='0':
...
outputDir = '/home/billywalker/data/ephys/' #This is where your modIndex files will be written
