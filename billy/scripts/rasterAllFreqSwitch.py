...
outputDir = '/home/billywalker/Pictures/raster_allFreq/'
...
for cellID in range(0,numOfCells):
    ...
    try:
        ...
        filename = 'rast_allFreq_%s_%s_%s_%s.%s'%(subject,behavSession,nameFreq,tetrodeClusterName,figformat)
