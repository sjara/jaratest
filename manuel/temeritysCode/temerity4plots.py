...
def comparison_plot(time, valuesData1, valuesData2, valuesData3, pVal, pVal1, pVal2): 
     ...
     label1 = 'config8_1: ITI= 5s, s.d= 0.2s','pval:',sp
     label2 = 'config8_2: ITI= 5s, s.d= 0.2s','pval:',sp1
     label3 = 'config8_3: ITI= 5s, s.d= 0.2s','pval:',sp2
     ...
     plt.savefig('nov24Pure004', format = 'pdf', dpi =50)
     plt.show() 
     return(plt.show())
...
def scatter_plots(preValues1, postValues1, preValues2, postValues2, preValues3, postValues3):
     ...
     scatterPlots[0].set_title('config6_1', fontsize = scatterLabelsSize)
     ...
     scatterPlots[1].set_title('config7', fontsize = scatterLabelsSize)
     ...
     scatterPlots[2].set_title('config6_2', fontsize = scatterLabelsSize)
     scatterPlots[2].tick_params(axis = 'x', labelsize = scatterXlabels)
     plt.suptitle('Average trials signals behavior: pure004_20211121', fontsize = scatterLabelsSize)
...
def barScat_plots(firstPlotMeanValues1, firstPlotMeanValues2, xlabel1, xlabel2, firstPlotStdData1, firstPlotStdData2, secondPlotMeanValues1, secondPlotMeanValues2, secondPlotStdData1, secondPlotStdData2, thirdPlotMeanValues1, thirdPlotMeanValues2, thirdPlotStdData1, thirdPlotStdData2, pVal1, pVal2, pVal3):
     ...
     shortPval1 = np.round(pVal1, decimals=5)
     ...
     barPlots[0].set_title('config8_1', fontsize = barLabelsFontSize)
     ...
     barPlots[1].set_title('config8_2', fontsize = barLabelsFontSize)
     ...
     barPlots[2].set_title('config8_3', fontsize = barLabelsFontSize)
     ...
     plt.ylim(100, 800)
     plt.suptitle('Pupil behavior before and after stimulus: pure004_20211124', fontsize = barLabelsFontSize)
...
proc = np.load('./temerity/pure004_20211121_syncSound_17_config6_proc.npy', allow_pickle = True).item()
...
proc1 = np.load(''./temerity/pure004_20211121_syncSound_16_config7_proc.npy', allow_pickle = True).item()
#Note: the proc.npy is the output file generated from facemap.
...
proc2 = np.load('./temerity/pure004_20211121_syncSound_15_config6_proc.npy', allow_pickle = True).item()
#Note: the proc.npy is the output file generated from facemap.
