'''
This script is for the project of pupil dilation. It is intended to obtain pupil data, its mean, the desired time windows, create a scatter, comparison, and bar plots
'''
...
proc = np.load('./project_videos/projectOutputs/pure002_20210928_syncVisibleNoSound_01_proc.npy', allow_pickle = True).item()
...
proc1 = np.load('./project_videos/projectOutputs/pure002_20210928_syncNoSound_01_proc.npy', allow_pickle = True).item()
#Note: the proc.npy is the output file generated from facemap.
...
proc2 = np.load('./project_videos/projectOutputs/pure002_20210928_syncSound_01_proc.npy', allow_pickle = True).item()
#Note: the proc.npy is the output file generated from facemap.
