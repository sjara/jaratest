# -*- coding: utf-8 -*-
"""
This script takes the database generated by database_generation_test.py and plots figures to 
compare D1 and nD1 cells using pure tone data.  

This script plots:
1. Latency (Time for cell response)
...
ONE_SUBJECT = 0 # Set to 1 to run for one test animal, set to 0 to run for all animals in study 
...
if LATENCY:
    ...
    latencydb = celldb.query('latency * 0 == 0')
...
if ONSET:
    ...
    onsetdb = celldb.query('tuningResponseRatio > {}'.format(latencyRatio))
