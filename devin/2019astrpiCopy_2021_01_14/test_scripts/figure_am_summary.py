...
compare D1 and nD1 cells using AM data.  
...
Created on Wed Jan 12 18:48:30 2021
...
celldb = celldb.query('AMBestRateOnset * 0 == 0')
...
if HIGHESTSUSTAINED:  
    highestSustaineddb = celldb.query('')
