...
exp = cellDB.Experiment(animalName='d1pi003', date ='2016-03-02', experimenter='lan', defaultParadigm='laser_tuning_curve') 


site1 = exp.add_site(depth=3280, tetrodes=[1,2,3,4,5,6,7,8]) #TT8 is ref
...
sitefuncs.nick_lan_daily_report_v2(site1, 'site1', mainRasterInds=[0,1,2,5], mainTCind=3)
#sitefuncs.lan_2afc_ephys_plots(site1, 'site1', main2afcind=3, tetrodes=[1,2,3,5,8]) 
sitefuncs.lan_2afc_ephys_plots_each_type(site1, 'site1', main2afcind=4, tetrodes=[1,2,3,4,5,6,7,8],trialLimit=[]) #not analyzed due to mismatch trial #s
