...
exp = cellDB.Experiment(animalName='adap012', date ='2016-03-18', experimenter='lan', defaultParadigm='laser_tuning_curve') 


site1 = exp.add_site(depth=2860, tetrodes=[1,2,3,4,5,6,7,8])
site1.add_session('13-18-00', None, sessionTypes['nb']) #amp=0.1
site1.add_session('13-20-01', 'a', sessionTypes['tc']) #2-40Hz chords, 50dB
site1.add_session('13-26-30', 'a', sessionTypes['2afc'], paradigm='2afc')
