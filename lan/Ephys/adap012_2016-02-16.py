...
exp = cellDB.Experiment(animalName='adap012', date ='2016-02-16', experimenter='lan', defaultParadigm='laser_tuning_curve') 


site1 = exp.add_site(depth=2500, tetrodes=[1,2,3,4,5,6,7,8])
site1.add_session('13-34-26', None, sessionTypes['nb']) #amp=0.1
site1.add_session('13-36-45', 'a', sessionTypes['tc']) #2-40Hz chords, 50dB
site1.add_session('13-42-42', 'b', sessionTypes['tc'])
site1.add_session('13-50-54', 'c', sessionTypes['tc'])
site1.add_session('13-55-09', 'a', sessionTypes['2afc'], paradigm='2afc')
