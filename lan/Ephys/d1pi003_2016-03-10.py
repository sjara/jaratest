...
exp = cellDB.Experiment(animalName='d1pi003', date ='2016-03-10', experimenter='lan', defaultParadigm='laser_tuning_curve') 


site1 = exp.add_site(depth=3440, tetrodes=[2,3,4,5,6,7,8]) #TT8 is ref
site1.add_session('15-03-22', None, sessionTypes['nb']) #amp=0.15
site1.add_session('15-05-40', None, sessionTypes['lp']) #power=1.5mW
site1.add_session('15-07-13', None, sessionTypes['lt']) #power=1.5mW
site1.add_session('15-08-34', 'a', sessionTypes['tc']) #2-40Hz chords, 50dB
site1.add_session('15-13-36', 'a', sessionTypes['2afc'], paradigm='2afc') 
...
sitefuncs.lan_2afc_ephys_plots_each_type(site1, 'site1', main2afcind=4, tetrodes=[2,3,4,5,6,7,8],trialLimit=[])
