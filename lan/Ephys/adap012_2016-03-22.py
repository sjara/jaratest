...
exp = cellDB.Experiment(animalName='adap012', date ='2016-03-22', experimenter='lan', defaultParadigm='laser_tuning_curve') 


site1 = exp.add_site(depth=2900, tetrodes=[1,2,3,4,5,6,7])
site1.add_session('12-57-52', None, sessionTypes['nb']) #amp=0.1
site1.add_session('13-00-05', 'a', sessionTypes['tc']) #2-40Hz chords, 50dB
