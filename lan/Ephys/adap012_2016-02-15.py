...
exp = cellDB.Experiment(animalName='adap012', date ='2016-02-15', experimenter='lan', defaultParadigm='laser_tuning_curve') 


site1 = exp.add_site(depth=2500, tetrodes=[7,8])
site1.add_session('12-13-08', None, sessionTypes['nb']) #amp=0.1
site1.add_session('12-15-29', 'a', sessionTypes['tc']) #2-40Hz chords, 50dB
site1.add_session('12-28-28', 'a', sessionTypes['2afc'], paradigm='2afc')
...
#sitefuncs.lan_2afc_ephys_plots_each_type(site1, 'site1', main2afcind=2, tetrodes=[4,5,6,7,8],trialLimit=[])
