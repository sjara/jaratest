...
exp = cellDB.Experiment(animalName='d1pi003', date ='2016-03-03', experimenter='lan', defaultParadigm='laser_tuning_curve') 


site1 = exp.add_site(depth=3280, tetrodes=[1,2,3,4,5,6,7]) #TT8 is ref
site1.add_session('17-42-05', None, sessionTypes['nb']) #amp=0.15
site1.add_session('17-44-49', None, sessionTypes['lp']) #power=1.5mW
site1.add_session('17-46-50', None, sessionTypes['lt']) #power=1.5mW
site1.add_session('17-48-24', 'a', sessionTypes['tc']) #2-40Hz chords, 50dB
site1.add_session('17-55-33', 'a', sessionTypes['2afc'], paradigm='2afc') 
