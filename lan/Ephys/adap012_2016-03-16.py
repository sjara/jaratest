...
exp = cellDB.Experiment(animalName='adap012', date ='2016-03-16', experimenter='lan', defaultParadigm='laser_tuning_curve') 


site1 = exp.add_site(depth=2820, tetrodes=[1,2,3,4,5,6,7,8])
site1.add_session('12-41-03', None, sessionTypes['nb']) #amp=0.1
site1.add_session('12-43-29', 'a', sessionTypes['tc']) #2-40Hz chords, 50dB
site1.add_session('12-51-49', 'a', sessionTypes['2afc'], paradigm='2afc')
