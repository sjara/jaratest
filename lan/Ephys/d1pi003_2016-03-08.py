...
exp = cellDB.Experiment(animalName='d1pi003', date ='2016-03-08', experimenter='lan', defaultParadigm='laser_tuning_curve') 


site1 = exp.add_site(depth=3400, tetrodes=[1,2,3,4,5,6,7,8]) #TT8 is ref
site1.add_session('15-04-01', None, sessionTypes['nb']) #amp=0.15
site1.add_session('15-05-38', None, sessionTypes['lp']) #power=1.5mW
site1.add_session('15-07-25', None, sessionTypes['lt']) #power=1.5mW
site1.add_session('15-09-18', 'a', sessionTypes['tc']) #2-40Hz chords, 50dB
site1.add_session('15-16-11', 'a', sessionTypes['2afc'], paradigm='2afc') 
