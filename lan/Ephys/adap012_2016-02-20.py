...
exp = cellDB.Experiment(animalName='adap012', date ='2016-02-20', experimenter='lan', defaultParadigm='laser_tuning_curve') 


site1 = exp.add_site(depth=2580, tetrodes=[1,2,3,4,5,6,7,8])
site1.add_session('14-42-01', None, sessionTypes['nb']) #amp=0.1
site1.add_session('14-53-32', 'a', sessionTypes['tc']) #2-40Hz chords, 50dB
site1.add_session('15-02-25', 'a', sessionTypes['2afc'], paradigm='2afc')
