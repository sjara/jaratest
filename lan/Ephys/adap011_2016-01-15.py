...
exp = cellDB.Experiment(animalName='adap011', date ='2016-01-15', experimenter='lan', defaultParadigm='laser_tuning_curve') 


site1 = exp.add_site(depth=3700, tetrodes=[1,2,3,5,6,7,8]) 
site1.add_session('13-22-08', None, sessionTypes['nb']) #amp=0.15
site1.add_session('13-25-35', 'a', sessionTypes['tc']) #2-40Hz chords, 50dB
...
sitefuncs.lan_2afc_ephys_plots_each_block_each_type(site1, 'site1', main2afcind=2, tetrodes=[5],trialLimit=[],choiceSide='left')
sitefuncs.lan_2afc_ephys_plots_each_block_each_type(site1, 'site1', main2afcind=2, tetrodes=[5],trialLimit=[],choiceSide='right')
