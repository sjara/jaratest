...
exp = cellDB.Experiment(animalName='d1pi003', date ='2016-03-16', experimenter='lan', defaultParadigm='laser_tuning_curve') 


site1 = exp.add_site(depth=3480, tetrodes=[2,3,4,5,6,7,8]) #TT8 is ref
site1.add_session('14-16-35', None, sessionTypes['nb']) #amp=0.15
site1.add_session('14-19-11', None, sessionTypes['lp']) #power=1.5mW
site1.add_session('14-20-21', None, sessionTypes['lt']) #power=1.5mW
site1.add_session('14-21-54', 'a', sessionTypes['tc']) #2-40Hz chords, 50dB
site1.add_session('14-28-12', 'a', sessionTypes['2afc'], paradigm='2afc') 
