...
if CASE == 2:
    ...
    processedDir = '/home/languo/data/ephys/switching_summary_stats/newMod/'
    for file in os.listdir(processedDir):
        modulationDf = pd.read_hdf(os.path.join(processedDir,file), key='switching')
        scriptFullPath = os.path.realpath(__file__)
        modulationDf['script'] = scriptFullPath
        modulationDf.to_hdf(os.path.join(processedDir,file), key='switching')
