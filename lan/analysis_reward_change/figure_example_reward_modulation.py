...
for alignment in examplesDict.keys():
    for brainRegion in examplesDict[alignment].keys():
        for indc, cell in enumerate(examplesDict[alignment][brainRegion]):
            ...
            fig.clf()
            fig.set_facecolor('w')
            figFilename = 'example_rc_{}_{}_{}'.format(alignment, brainRegion, indc+1)
            rasterFilename = 'example_rc_{}aligned_raster_{}.npz'.format(alignment,cell) 
            ...
            psthFilename = 'example_rc_{}aligned_psth_{}.npz'.format(alignment,cell) 
