...
for ind, cell in cellsToPlot.iterrows(): 
    ...
    figname = '{}_{}_T{}_c{}_switching_mod_premovement.png'.format(cell['animalName'],cell['behavSession'],cell['tetrode'],cell['cluster'])
    ...
    plt.xlabel('Time from movement onset (s)',fontsize=fontSizeLabels, labelpad=labelDis)

    plt.title('modInd:{};\n modSig:{}; maxZ:{}'.format(cell['modInd_-0.1-0s_center-out'],cell['modSig_-0.1-0s_center-out'],cell['maxZSoundMid']), fontsize=fontSizeLabels-2)
