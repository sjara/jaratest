...
df1 = celldatabase.load_hdf("/var/tmp/figuresdata/2019astrpi/direct_and_indirect_cells_basic.h5")
df2 = celldatabase.load_hdf("/var/tmp/figuresdata/2019astrpi/sorted_cell_index.h5")
newDF = pd.merge(df1, df2, on=['subject', 'tetrode', 'cluster', 'date', 'depth'], indicator=True)
newDF
df2.__len__()
