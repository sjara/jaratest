...
#cluster6 = site5.add_cluster(clusterNumber=6, tetrode=3, soundResponsive=True, laserPulseResponse=True, followsLaserTrain=True, comments='for panels BCD'); # Added by Santiago
