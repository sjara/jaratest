...
SESSION_TYPES = ['poniFreq_4x4','poniFreq_4x1','poniFreq_1x4', 'poniFreq_4x4_CiRj_2x2','optoFreq']
...
TIME_RANGES = {
                ...
                'Evoked':       [0.015, 0.265],
                'Onset':        [0.015, 0.065],
                'Sustained':    [0.065, 0.235],
                'Offset':       [0.215, 0.265],
                'Delayed':      [0.265, 0.415],
                'FullResponse':   [0.015,0.415]
            }
...
METRICS = ['BaselineFiringRate', 'Ntrials', 'BaselineSigma', 'FiringRateEachFreq',
                'ResponseMinPval', 'SelectivityPval', 'FiringRateBestFreq', 'BestFreq', 
                'AvgEvokedFiringRate', 'GaussianA', 'GaussianX0', 'GaussianSigma', 
                'GaussianY0', 'GaussianRsquare','DiscrimEachFreq','MeanDiscrim',
                'SigmaEachFreq','DiscrimBestFreq']
