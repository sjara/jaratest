...
!!! DEPRECATED !!!
-> use am_image_tuning.py instead 
"""
...
class Paradigm(QtWidgets.QMainWindow):
    def __init__(self, parent=None, paramfile=None, paramdictname=None):
        ...
        self.params['subGridPosH'] = paramgui.NumericParam('Horizontal position of subregion in the full image grid', value = 0,
                                                       decimals=0, units='pixels',group='Image parameters')
        self.params['subGridPosV'] = paramgui.NumericParam('Vertical position of subregion in the full image grid', value = 0,
                                                       decimals=0, units='pixels',group='Image parameters')
