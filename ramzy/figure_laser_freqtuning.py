...
if not justCurves:
    ...
    metricTicks = [[2000, 8000, 32000], [0, 3, 6], [0, 5, 10]]
    ...
    for indcell, cellInd in enumerate(cellsToPlot):
        ...
        axTuning.legend([allFits[0], allFits[1]], ['off', 'on'], loc='upper left', handlelength=1)
    ...
    if SAVE_FIGURE:
        ...
        extraplots.save_figure(figFilename+cellstring, figFormat, figSize, outputDir)
    ...
    for pageNum, cellsToPlot in enumerate(cellInds):
        ...
        if SAVE_FIGURE:
            ...
            extraplots.save_figure(figFilename+'_Just_Curves'+cellstring, figFormat, figSize, outputDirNew)