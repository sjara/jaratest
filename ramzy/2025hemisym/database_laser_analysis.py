...
This script adds columns to the database with tuning results for each stimulus condition:
    - Slow (4 Hz) or Fast (64 Hz) AM rate
    - With or without laser

On a laptop (Apple M4 pro, 14 core), takes 6~10 minutes to run.
"""
