...
sessionsEachSubject = { 
    'pals001': [#'20210224a', '20210225a', '20210226a', '20210227a', '20210228a', '20210301a', '20210302a',
                # '20210303a', '20210304a',  '20210306a', '20210307a', '20210308a', '20210309a', '20210310a',
                # '20210331a',
                #  '20210401a', '20210402a', '20210403a', '20210404a', '20210405a', '20210406a', '20210408a',
                #'20210409a', '20210410a',
                # '20210413a', '20210414a', 
                # '20210423a', 
                '20210424a', '20210425a', '20210426a', '20210427a', '20210428a', '20210429a' , '20210430a', '20210501a', '20210502a',
                '20210503a', '20210504a','20210505a', '20210506a', '20210507a', '20210508a', '20210510a', '20210511a'],
    
    'pals002': [#'20210331a', '20210401a', '20210402a', '20210403a', '20210404a', '20210405a', '20210406a', '20210407a',
                 #'20210408a', '20210409a', '20210410a', '20210412a', '20210413a', '20210414a', '20210423a', '20210424a',
                 '20210425a',
                '20210426a', '20210427a', '20210428a', '20210501a', '20210502a','20210503a', '20210504a','20210505a', '20210506a', '20210507a', '20210508a',
                '20210510a', '20210511a'],
    
    'pals003': [#'20210219a','20210220a','20210221a','20210222a', '20210223a', '20210224a', '20210225a',
                #'20210226a', '20210227a', '20210228a', '20210301a', '20210302a',
                #'20210303a', '20210304a',  '20210306a', '20210307a', '20210308a', '20210309a', '20210310a',
                #'20210331a', '20210401a',
                # '20210402a', '20210403a', '20210404a', '20210405a', '20210406a', '20210407a',
                 #'20210408a', '20210409a', '20210410a', '20210413a', '20210414a',
                 #'20210423a',
                '20210424a', '20210425a', '20210426a', '20210427a', '20210428a', '20210429a', '20210430a', '20210501a', '20210502a',
                '20210503a', '20210504a','20210505a', '20210506a', '20210507a', '20210508a', '20210510a', '20210511a'],
    
    #'pals004': ['20210223a', '20210224a', '20210226a', '20210227a', '20210228a', '20210302a',
     #           '20210303a', '20210304a',  '20210306a', '20210307a', '20210308a,
      #          '20210401a', '20210402a'],
    
    'pals005': [#'20210220a','20210222a', '20210223a', '20210224a', '20210225a',
                #'20210226a', '20210227a', '20210228a', '20210301a', '20210302a',
                #'20210303a', '20210304a',  '20210306a', '20210307a', '20210308a', '20210309a', '20210310a'
                #'20210401a',
                 #'20210402a', '20210403a', '20210404a', '20210405a', '20210407a', '20210408a', '20210409a',
                 #'20210410a', '20210413a', '20210414a',
                
                '20210423a', '20210424a', '20210425a', '20210426a', '20210428a', '20210429a', '20210430a', '20210501a', '20210502a',
                '20210503a', '20210504a','20210505a', '20210506a', '20210507a', '20210508a', '20210510a', '20210511a'],
   
     'pals007': [#'20210331a', '20210401a', '20210402a', 
                  #'20210403a', '20210404a', '20210405a', '20210407a', '20210408a',
                  #'20210409a', '20210410a', '20210412a', '20210413a', '20210414a', 
                  #'20210423a', '20210424a', 
                 '20210425a', '20210426a', '20210427a', '20210428a', '20210430a', '20210501a', '20210502a',
                 '20210503a', '20210504a','20210505a', '20210506a', '20210507a', '20210508a', '20210510a', '20210511a'],
    
      'pals008': [#'20210331a', '20210401a', '20210402a', '20210403a', 
                   #'20210404a', '20210405a', '20210407a', '20210408a',
                   #'20210409a', '20210410a', '20210412a', '20210413a', '20210414a',
                   #'20210423a',
                 '20210424a', '20210425a', '20210428a', '20210430a', '20210501a', '20210502a',
                 '20210503a', '20210504a','20210505a', '20210506a', '20210507a', '20210508a', '20210510a', '20210511a'],
...
for subject in subjects: 
    ...
    (stage_information['task_mode'] == 3) & (stage_information['reward_side_mode'] == 4) & (stage_information['lick_offset'] == 1),
...
# #BELOW IS CODE USED FOR PLOTS OF PERFORMANCE AND THE PLOTS TYPICALLY USED IN STAGE 3 AND 3.5
    ...
    # fig.savefig(r'C:\Users\isabe\data\behavior_graphs\{}\{}performance.png' .format(subject, subject), dpi=100)
