...
if subject == 'febe007':
    sessions = ['20220604a', '20220605a']
    #sessions = ['20220529a', '20220531a', '20220601a', '20220602a'] #uniform 20220530a',
    #sessions = ['20220517a', '20220518a', '20220519a', '20220521a', '20220522a', '20220523a','20220524a', '20220525a', '20220528a'] #extremes80pct '20220516a',  '20220520a',, '20220526a' '20220527a', '
elif subject == 'febe008':
    sessions = ['20220604a', '20220605a']
    #sessions = ['20220517a', '2022018a', '20220519a', '20220520a', '20220521a', '20220522a', '20220523a','20220524a', '20220525a', '20220528a', '20220529a', '20220601a', '20220602a'] #uniform , '20220526a', '20220527a', '20220530a', '20220531a',
    ...
    sessions = ['20220604a', '20220605a']
    #sessions = [ '20220520a', '20220521a', '20220522a', '20220523a','20220524a', '20220525a', '20220526a', '20220527a', '20220528a', '20220529a', '20220530a', '20220531a', '20220601a', '20220602a'] #uniform Biased:'20220517a', '2022018a', '20220519a',
    #sessions = ['20220503a', '20220504a', '20220505a', '20220506a', '20220507a', '20220508a', '20220509a', '20220510a', '20220511a', '20220512a', '20220513a', '20220514a', '20220515a', '20220516a'] #extremes80pct
elif subject == 'febe012':
    sessions = ['20220604a', '20220605a']
    #sessions = ['20220529a', '20220530a', '20220531a', '20220601a', '20220602a'] #uniform
...
if bdata['irrelevantFeatureMode'][-1] == bdata.labels['irrelevantFeatureMode']['random']:
    ...
    for indIrrelevant, thisIrrelevant in enumerate(possibleIrrelevantFreq):
        theseTrials = trialsEachCond[:, indIrrelevant] & valid
        (possibleValues,fractionHitsEachValue,ciHitsEachValue,nTrialsEachValue,nHitsEachValue) = behavioranalysis.calculate_psychometric(rightChoice, targetFrequency, theseTrials)
