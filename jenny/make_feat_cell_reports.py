...
for indMouse, thisMouse in enumerate(allSubjects):
    ...
    for indRow, dbRow in celldb.iterrows():
        ...
        figPath = os.path.join(settings.FIGURES_DATA_PATH, studyparams.STUDY_NAME, 'cell_reports', f'{subject}_{dbRow.date}_{dbRow.maxDepth}um_c{dbRow.cluster}_report.png')
