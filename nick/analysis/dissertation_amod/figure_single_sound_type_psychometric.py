...
musFilename = 'psychometric_{}_muscimol.npz'.format(subject)
musFullPath = os.path.join(dataDir,musFilename)
musData = np.load(musFullPath)

salFilename = 'psychometric_{}_saline.npz'.format(subject)
...
if SAVE:
    plt.savefig('/home/nick/data/dissertation_amod/figure_{}_single_sound_type.png'.format(subject))
