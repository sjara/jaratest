...
exp0.add_site(3757, tetrodes=[3, 6])
...
exp0.add_site(3805, tetrodes=[3, 6])
...
exp1.add_site(3325, tetrodes=[3, 6])
...
exp1.add_site(3825, tetrodes=[3, 6])
...
exp1.add_site(3875, tetrodes=[3, 6])
...
exp1.add_site(3925, tetrodes=[3, 6])
...
exp1.add_site(3975, tetrodes=[3, 6])
...
exp1.add_site(4025, tetrodes=[3, 6])
...
exp2.add_site(3509, tetrodes=[3, 6])
...
exp2.add_site(3550, tetrodes=[3, 6])
...
exp2.add_site(3606, tetrodes=[3, 6])
...
exp2.add_site(3654, tetrodes=[3, 6])
...
exp3.add_site(3700, tetrodes=[5, 6])
...
exp3.add_site(3751, tetrodes=[5, 6])
...
exp4.add_site(3425, tetrodes=[4, 5, 6])
exp4.add_session('10-21-34', None, 'NoiseBurst', 'laser_tuning_curve')
exp4.add_session('10-24-16', None, 'LaserPulse', 'laser_tuning_curve')
exp4.add_session('10-26-57', None, 'LaserTrain', 'laser_tuning_curve')
exp4.add_session('10-30-48', 'a', 'TuningCurve', 'laser_tuning_curve')


# site2 = rd.add_site(depth = 3451, tetrodes = [5, 6])

exp4.add_site(3451, tetrodes=[5, 6])
exp4.add_session('10-58-42', None, 'LaserPulse', 'laser_tuning_curve')
exp4.add_session('11-01-08', None, 'LaserTrain', 'laser_tuning_curve')
exp4.add_session('11-05-29', None, 'NoiseBurst', 'laser_tuning_curve')
exp4.add_session('11-08-42', 'b', 'TuningCurve', 'laser_tuning_curve')
exp4.add_session('11-23-51', 'c', 'TC_3k-13k_16f_20-50_4ints', 'laser_tuning_curve')


# site3 = rd.add_site(depth = 3602, tetrodes = [5, 6])

exp4.add_site(3602, tetrodes=[5, 6])
exp4.add_session('11-51-31', None, 'NoiseBurst', 'laser_tuning_curve')
exp4.add_session('11-54-05', None, 'LaserPulse', 'laser_tuning_curve')
exp4.add_session('11-56-36', None, 'LaserTrain', 'laser_tuning_curve')
