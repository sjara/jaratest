...
site1 = rd.add_site(depth = 3100, tetrodes = [5])
...
sitefuncs.nick_lan_daily_report(site5, 'site2', mainRasterInds=[0, 1, 2], mainTCind=None)
...
sitefuncs.nick_lan_daily_report(site3, 'site3', mainRasterInds=[0, 1, 2], mainTCind=None)
sitefuncs.am_mod_report(site3, 'site3', amSessionInd=3)

#Going to re-record a new site without moving. 



site4 = rd.add_site(depth = 3452, tetrodes = [5, 6])
