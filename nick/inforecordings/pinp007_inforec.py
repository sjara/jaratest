...
exp0.add_site(3100)
exp0.add_session('16-56-20', None, 'NoiseBurst', 'am_tuning_curve') #Amplitude at 0.02, onset and offset responses on TT4
exp0.add_session('16-59-10', None, 'LaserPulse', 'am_tuning_curve') #Paradigm=laser_tuning_curve, 1mW  - Responds but is then inhibited, TT4
exp0.add_session('17-02-10', None, 'LaserTrain', 'am_tuning_curve') #Paradigm=laser_tuning_curve, 1mW  -
exp0.add_session('17-07-37', 'a', 'AM', 'am_tuning_curve') # Cool offset responses

site2 = rd.add_site(depth = 3300, tetrodes = [3, 4, 5, 6])
exp0.add_session('17-52-33', None, 'NoiseBurst', 'am_tuning_curve') #Amplitude at 0.02,
exp0.add_session('17-55-32', None, 'LaserPulse', 'am_tuning_curve') #Paradigm=laser_tuning_curve, 1mW  - Fast response and then inhibited
exp0.add_session('17-58-23', None, 'LaserPulse', 'am_tuning_curve') #Paradigm=laser_tuning_curve, 1mW  -
exp0.add_session('18-02-53', 'b', 'AM', 'am_tuning_curve') #


# site3 = rd.add_site(depth = 3463, tetrodes = [3, 4, 5, 6])

exp0.add_site(3463)
exp0.add_session('18-37-51', None, 'NoiseBurst', 'am_tuning_curve') #Amplitude at 0.02,
exp0.add_session('18-40-23', None, 'LaserPulse', 'am_tuning_curve')
exp0.add_session('18-42-33', None, 'LaserTrain', 'am_tuning_curve')
exp0.add_session('18-49-14', 'c', 'AM', 'am_tuning_curve') #

# site4 = rd.add_site(depth = 3582, tetrodes = [3, 4, 5, 6])

exp0.add_site(3463)
exp0.add_session('19-15-56', None, 'NoiseBurst', 'am_tuning_curve') #Still mostly on and offset resp.
exp0.add_session('19-20-01', None, 'LaserPulse', 'am_tuning_curve')
exp0.add_session('19-23-55', None, 'LaserTrain', 'am_tuning_curve')
exp0.add_session('19-28-25', 'd', 'AM', 'am_tuning_curve')
