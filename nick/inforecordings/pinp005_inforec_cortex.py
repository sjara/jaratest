...
exp0.add_session('00-04-11', 'g', 'TuningCurve', 'laser_tuning_curve') #Laser responses on TT4
exp0.add_session('00-17-11', 'h', 'TuningCurveLower', 'laser_tuning_curve') #Another 160 trials to get the cf
exp0.add_session('00-20-17', None, 'LaserTrain', 'laser_tuning_curve')
exp0.add_session('00-24-39', 'i', 'TuningCurveHigher', 'laser_tuning_curve') #Another 160 trials at 70dB to get a better TC for TT4 - it has a very high threshold
