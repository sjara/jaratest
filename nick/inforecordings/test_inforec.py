...
#7.5 - 6.5mW #72 trials
exp0.add_session('16-10-12', None, '6.5mW', paradigm='am_tuning_curve')

#8.5 - 6.9mW
exp0.add_session('16-11-20', None, '6.9mW', paradigm='am_tuning_curve')

#9.5 - 7.2mW
exp0.add_session('16-12-06', None, '7.2mW', paradigm='am_tuning_curve')

exp1 = celldatabase.Experiment('lasertest', '2016-08-23')
