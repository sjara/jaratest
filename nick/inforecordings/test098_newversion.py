...
# inforec = celldb.InfoRecording('inforec')
# inforec = celldb.InfoRecording('test098')
...
#Has no name
# experiments.append(celldb.Experiment(subject, '2016-07-26'))
# experiments[0].add_site(3100)
